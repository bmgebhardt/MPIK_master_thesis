...
\begin{wrapfigure}{R}{0.4\textwidth}
\centering
\includegraphics[width=0.4\textwidth,trim=40cm 25cm 35cm 25cm, clip=true]{D:/OwnCloudData/00_WriteUp/04_Thesis/Pic/LVR6mmPIC.JPG}
...
\resizebox{0.4\columnwidth}{!}{\includegraphics[trim=0cm 0cm 0cm 0, clip=true]{D:/OwnCloudData/02_Results/HPK_S12642/PIXELCOMPARE/CHECS-tile_pixel_comp_DCR_vs_OV_Combined}}
\caption{}
\label{fig:}
\end{centering}
\end{figure}
